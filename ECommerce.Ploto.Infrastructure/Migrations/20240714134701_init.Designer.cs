            ...
            modelBuilder.Entity("ECommerce.Ploto.Domain.Models.Permission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("013c45a2-8eac-4ad1-b25e-088f7bd592bd"),
                            PermissionType = 1
                        },
                        new
                        {
                            Id = new Guid("01e99a1f-8515-44d5-8e1f-c89b7bb5d00a"),
                            PermissionType = 0
                        });
                });
            ...
            modelBuilder.Entity("ECommerce.Ploto.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bacf4a5f-af63-4477-b067-58934f0dd727"),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = new Guid("6fa2203e-e2b0-4285-ac0d-3f55025b790e"),
                            Name = "User"
                        });
                });
            ...
            modelBuilder.Entity("ECommerce.Ploto.Domain.Models.RolePermissionModel.RolePermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("709de083-16c2-403a-9c47-b9008119235e"),
                            PermissionId = new Guid("013c45a2-8eac-4ad1-b25e-088f7bd592bd"),
                            RoleId = new Guid("bacf4a5f-af63-4477-b067-58934f0dd727")
                        },
                        new
                        {
                            Id = new Guid("3dd3ec51-94a5-44c5-81d0-3dee082b2884"),
                            PermissionId = new Guid("01e99a1f-8515-44d5-8e1f-c89b7bb5d00a"),
                            RoleId = new Guid("bacf4a5f-af63-4477-b067-58934f0dd727")
                        },
                        new
                        {
                            Id = new Guid("77671f81-845e-4b5f-919a-1a603f91434c"),
                            PermissionId = new Guid("013c45a2-8eac-4ad1-b25e-088f7bd592bd"),
                            RoleId = new Guid("6fa2203e-e2b0-4285-ac0d-3f55025b790e")
                        });
                });
            ...
            modelBuilder.Entity("ECommerce.Ploto.Domain.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e416fdf8-6fdb-4b3e-b74a-7450cd8f9f5d"),
                            Password = "123456",
                    ...
                    b.OwnsOne("ECommerce.Ploto.Domain.Models.Address", "Address", b1 =>
                        {
                            ...
                            b1.HasData(
                                new
                                {
                                    UserId = new Guid("e416fdf8-6fdb-4b3e-b74a-7450cd8f9f5d"),
                                    Avenue = "resalat",
                                    City = "tehran",
                                    HouseNO = 54
                                });
